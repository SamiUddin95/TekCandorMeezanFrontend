            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./outward-clearing/pages/batch-file-upload/batch-file-upload.component').then(mod => mod.BatchFileUploadComponent),
                        data: { title: 'Batch File Upload' }
                    },
                    {
